...
const CardDepartment = ({id, title, description, logo, color}: CardAboutProps) => {
    return (
        <div
            className="relative w-full max-w-2xl p-8 bg-[#F8FAFF] border border-secondary rounded-4xl overflow-hidden font-sans">
            <div

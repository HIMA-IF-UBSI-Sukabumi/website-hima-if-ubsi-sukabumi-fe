...
const CardDepartment = ({
    ...
    return (
        <Link href={href || "#"} className="block h-full">
            <div
                className="relative w-full max-w-2xl h-full min-h-85 p-8 border border-secondary rounded-4xl overflow-hidden font-sans flex flex-col bg-white hover:shadow-lg transition"
            >
